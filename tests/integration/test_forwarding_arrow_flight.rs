//! Integration test for forwarding enabled with Arrow Flight endpoint
...
#[tokio::test]
async fn test_forwarding_enabled_arrow_flight() {
    let temp_dir = TempDir::new().unwrap();
    
    // Configure forwarding to Arrow Flight endpoint
