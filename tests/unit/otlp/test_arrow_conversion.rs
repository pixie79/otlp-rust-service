...
async fn test_arrow_ipc_conversion_traces() {
    ...
    for batch_result in reader {
        ...
        assert!(schema.field_with_name("trace_id").is_some(), "Schema should have trace_id field");
        assert!(schema.field_with_name("span_id").is_some(), "Schema should have span_id field");
        assert!(schema.field_with_name("name").is_some(), "Schema should have name field");
